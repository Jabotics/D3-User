...
const MembershipCheckout = () => {
  ...
  return (
    <>
      {hasSubmit ? (
        <div className="h-screen w-screen relative overflow-hidden bg-[#53a53fa8]">
          <HeroLoader />
        </div>
      ) : (
          ...
          <div className="w-full md:w-4/5">
            {isHidden ? (
                ...
                <div className="flex flex-col gap-4 w-full border rounded-lg bg-[#FFFFFF]">
                  <div className="flex flex-row justify-center items-center self-center mt-auto w-full px-2 ">
                    <p className="p-0 m-0 text-[#53a53f9d] text-[10px] ">
                      Offer 10% additional discount for 3 hours booking on
                      weekdays only
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-10 flex flex-col gap-4">
                ...
                <MembershipCheckoutSummary hasSubmit={setHasSubmit} />
                <Coupan />
                <CacelationPolicy />
              </div>
            )}
