const VissionMission = () => {
  return (
    <div className="my-6">
      <h1 className="text-xl lg:text-2xl font-medium">Our Vision and Mission</h1>
      <div className="w-full flex items-start my-3">
        <div className="w-8">1.</div>
        <div className="flex-1 flex-col">
          <h3 className="text-sm md:text-lg tracking-wide font-medium">Vision</h3>
      ...
      <div className="w-full flex items-start my-3">
        ...
        <div className="flex-1 flex flex-col">
          <h3 className="text-sm md:text-lg tracking-wide font-medium mb-4">Mission</h3>
          <span className="text-sm mb-5 md:mb-0">
