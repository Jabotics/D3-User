...
const Commitment = () => {
  return (
    <div className="my-10">
      <h1 className="text-xl lg:text-2xl font-medium">Our Commitment to the Community</h1>
        ...
        <div className="flex flex-col">
          <span className="text-xs md:text-sm mb-5 md:mb-0 flex items-start md:items-center justify-start">
            <span className="font-semibold flex items-center gap-2 w-3/5 md:w-fit">
              <FaCircle size={5} className="hidden md:inline-block" /> Inclusivity and Accessibility:{" "}
            </span>
            <span className="ml-2">
          ...
          <span className="text-xs md:text-sm mb-5 md:mb-0 flex items-start md:items-center justify-start">
            <span className="font-semibold flex items-center gap-2 w-3/5 md:w-fit">
              <FaCircle size={5} className="hidden md:inline-block" /> Youth Empowerment:{" "}
            </span>
            <span className="ml-2">
          ...
          <span className="text-xs md:text-sm mb-5 md:mb-0 flex items-start md:items-center justify-start">
            <span className="font-semibold flex items-center gap-2 w-3/5 md:w-fit">
              <FaCircle size={5} className="hidden md:inline-block" /> Community Engagement:{" "}
            </span>
            <span className="ml-2">
          ...
          <span className="text-xs md:text-sm mb-5 md:mb-0 flex items-start md:items-center justify-start">
            <span className="font-semibold flex items-center gap-2 w-3/5 md:w-fit">
              <FaCircle size={5} className="hidden md:inline-block" /> Sustainability:{" "}
            </span>
            <span className="ml-2">
