...
const FaqAcademyComponent = ({
  academy,
}: {
  academy: React.MutableRefObject<HTMLDivElement | null>;
}) => {
  const {
    data: Faqs,
    isLoading,
  ...
  return (
    <div id="play" ref={academy} className="my-5">
      {isLoading ? (
        <></>
      ) : Faqs && Faqs?.data.length > 0 ? (
        <div className="flex flex-col">
          <p className="text-2xl mb-8">Academy</p>
...
export default FaqAcademyComponent;
