        ...
        <div className="flex flex-col w-full pt-14">
          ...
          <div className="form-section flex flex-col gap-3 mt-8">
            <div className="input-box relative flex flex-row items-center">
              ...
              <InputText id="username" aria-describedby="username-help" placeholder='Name' className='w-full p-2 rounded-3xl pl-10 border '/>
            </div>
            ...
            <div className="input-box relative flex flex-row items-center">
              ...
              <InputText id="mail" aria-describedby="mail" placeholder='Email' className='w-full p-2 rounded-3xl pl-10 border '/>
            </div>
            ...
            <Button label="Sign Up" className='submit-buttn w-full text-white bg-black  rounded-3xl p-3 font-medium mt-4' />
