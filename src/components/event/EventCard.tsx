    ...
    <div className="flex flex-col gap-2 w-[100%] md:w-[60%]  items-center rounded-lg bg-[#f3f4f6] px-1">
      <div className="flex flex-col border-2 rounded-lg w-[100%] md:w-[80%]">
        <img
          src={`${event?.image}`}
          alt="img"
          className="w-full h-[240px] md:h-[400px] object-cover bg-red border-t-1 rounded-t-md"
        />
      ...
      <div className="flex flex-col md:w-[80%] w-[100%] gap-1 p-1 ">
        <span className="inline-block text-[18px] font-semibold self-start">
          {event?.name}
        </span>
        ...
        <span className="inline-block text-[16px] font-normal">
          {event?.description}
        </span>
      </div>
    </div>
