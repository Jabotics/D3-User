...
export const TestimonialCard = ({ data }: { data?: IHappyCustomers }) => {
  return (
    <div className="px-4">
        ...
        <div className="viewer flex justify-end w-full gap-4 align-center -mt-5 md:mt-0">
          ...
          <div className="flex flex-col items-end justify-start">
            <p className="font-semibold text-[8px] md:text-[16px]">
              {data && data.name ? data.name : `Chirag Chedda`}
            </p>
            {/* <small className="text-[6px] md:text-xs font-medium text-zinc-600">
              pAY n pLAY uSER
            </small> */}
          </div>
        </div>
