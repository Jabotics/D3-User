...
const MembershipCheckoutDetails: React.FC<MembershipCheckoutDetailsProps> = ({
  registrationFormDetails,
}) => {
              ...
              {selectedMembership ? (
                <div className="flex items-center space-x-2">
                  <RadioGroupItem
                    ...
                    id="r1"
                    onClick={() => {
                      const fee = Number(selectedMembership?.monthly_fee);
              ...
              {selectedMembership ? (
                <div className="flex items-center space-x-2 ml-10">
                  <RadioGroupItem
                    ...
                    id="r2"
                    onClick={() => {
                      const fee = selectedMembership?.quarterly_fee;
              ...
              {selectedMembership ? (
                <div className="flex items-center space-x-2">
                  <RadioGroupItem
                    ...
                    id="r3"
                    onClick={() => {
                      const fee = selectedMembership?.half_yearly_fee;
                      dispatch(
              ...
              {selectedMembership ? (
                <div className="flex items-center space-x-2 ml-10">
                  <RadioGroupItem
                    ...
                    id="r4"
                    onClick={() => {
                      const fee = selectedMembership?.yearly_fee;
        ...
        <div className="flex-1 w-full border border-[#53a53f44] rounded-md flex flex-col items-start py-5 px-5">
          {/* <div className="h-6 lg:h-10 w-full mb-2">
            <div className="h-full w-full ">
              {selectedMembership && (
                <span className="text-base lg:text-xl">{selectedMembership.name}</span>
              )}
              <Separator />
            </div>
          </div> */}
...
export default MembershipCheckoutDetails;
