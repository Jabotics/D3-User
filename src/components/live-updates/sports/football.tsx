  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 w-full h-full">
            ...
            <div className="w-full flex-1 flex items-start justify-between px-10">
              <div className="h-fit mt-10 text-sm flex flex-col gap-2">
                <span className="flex items-center gap-5">
                  ...
                  <p className="flex items-center">+1 Goal</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  ...
                  <p className="flex items-center gap-2 text-gray-700">
                    <BiSolidCard className="text-amber-400" size={20} /> Card
                  </p>{" "}
                </span>
        ...
        <div className="w-full sm:hidden h-fit flex flex-col">
          ...
          <div className="w-full flex-1 ">
            <div className="w-full h-40 flex items-start justify-evenly text-4xl">
              <div className="border-[1px] flex flex-col items-center justify-center border-gray-300 py-5 px-7 sm:py-7 sm:px-10 rounded-md cursor-pointer">
      ...
      <div className="flex-1 w-full hidden sm:flex flex-col">
        ...
        <div className="w-full h-60 flex items-start justify-between px-10">
          <div className="h-fit mt-10 text-sm flex flex-col gap-2">
            <span className="flex items-center gap-5">
              <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
              <p className="text-gray-400">01.25</p>{" "}
