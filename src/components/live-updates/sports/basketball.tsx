      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 w-full h-full">
        <div className="h-fit sm:h-full w-full sm:w-1/2 flex flex-col gap-5">
          <div className="h-28 sm:h-60 w-full bg-gray-100 rounded-2xl flex overflow-hidden items-center relative">
            ...
            ></div>
            <div className="absolute h-full w-full left-0 top-0 bg-gray-600/60" />
            ...
            <div className="w-full flex-1 flex items-start justify-between px-10">
              <div className="h-fit mt-10 text-sm flex flex-col gap-2">
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">01.25</p>{" "}
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">07.52</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">08.37</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+3 Points</p>{" "}
                </span>

                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">08.59</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>

                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">09.32</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">10.05</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">12.37</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
              </div>
              ...
              <div className="h-fit mt-10 text-sm flex flex-col gap-2">
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">03.37</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">05.32</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center gap-2 text-gray-700">
                    Fouled
                  </p>{" "}
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">05.55</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">06.37</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">07.12</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
                ...
                <span className="flex items-center gap-5">
                  <MdOutlineAccessTimeFilled className="text-gray-400" />{" "}
                  <p className="text-gray-400">07.58</p>{" "}
                  <p className="h-px w-20 bg-gray-500" />{" "}
                  <p className="flex items-center">+2 Points</p>{" "}
                </span>
              </div>
            ...
            <div className="w-full h-40 flex items-start justify-evenly text-2xl sm:text-4xl">
              <div className="grid grid-cols-2 grid-rows-2 gap-4 h-full">
                ...
                <div className="px-1 py-1 sm:px-3 sm:py-3 border border-gray-200 rounded-md flex items-center justify-center">
                  <span className="text-xl sm:text-3xl text-gray-500">Foul</span>
                </div>
              </div>
              <div className="grid grid-cols-2 grid-rows-2 gap-4 h-full">
                <div className="px-1 py-1 sm:px-3 sm:py-3 border border-gray-200 rounded-md flex flex-col items-center justify-center">
