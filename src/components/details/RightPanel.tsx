    ...
    <div className="w-[19rem] xs:w-[21rem] sm:w-[36rem] md:w-[44rem] lg:w-[28rem] xl:w-[680px] lg:h-[28rem] h-80 xl:h-[523px] ml-2">
      <div className="flex justify-between">
        <span className="text-lg tracking-widest">
          {groundDetails?.supported_sports[0]?.name},
          {groundDetails?.supported_sports[1]?.name}{" "}
        </span>
      ...
      <h2 className="md:text-3xl text-2xl md-mt-0 mt-3 font-bold">
        {groundDetails?.name}
      </h2>
      <div className="mt-2">
        <span className="font-light text-sm">
          New Ground {groundDetails?.dimensions?.width} x{" "}
