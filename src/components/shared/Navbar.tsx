            ...
            <div className="col-span-8 sm:col-span-5 max-[290px]:col-span-4  max-[350px]:col-span-5 lg:col-span-7 gap-4 flex justify-end  items-center custome-break sm:mr-2">
              {isLarge && (
                <div className="max-lg:hidden flex items-center justify-start gap-2">
                  <Button
                    variant={"outline"}
                    className={` px-12 text-xs h-7 rounded-3xl ${pathName.pathname === "/about"
                  ...
                  <Button
                    variant={"outline"}
                    className={` px-12 text-xs h-7 rounded-3xl ${pathName.pathname === "/pay_play"
                        ? "bg-green-500 text-gray-50 hover:bg-green-400"
                        : ""
                      }`}
                    onClick={() => {
                  ...
                  <Button
                    variant={"outline"}
                    className={` px-12 text-xs h-7 rounded-3xl ${pathName.pathname === "/academy"
                        ? "bg-green-500 text-gray-50 hover:bg-green-400"
                        : ""
                      }`}
                  >
                  ...
                  <Button
                    ...
                    className={` px-12 text-xs h-7 rounded-3xl ${pathName.pathname === "/membership"
                        ? "bg-green-500 text-gray-50 hover:bg-green-400"
                        : ""
                      }`}
                  >
                  ...
                  <Button
                    variant={"outline"}
                    className={` px-12 text-xs h-7 rounded-3xl ${pathName.pathname === "/contact"
                        ? "bg-green-500 text-gray-50 hover:bg-green-400"
                        : ""
                      }`}
                    onClick={() => {
